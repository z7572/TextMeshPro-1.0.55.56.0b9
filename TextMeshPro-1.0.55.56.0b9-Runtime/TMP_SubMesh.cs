...
namespace TMPro
{
	...
	public class TMP_SubMesh : MonoBehaviour
	{
		...
		private void ON_MATERIAL_PROPERTY_CHANGED(bool isChanged, Material mat)
		{
			...
			int num = (!(this.m_fallbackSourceMaterial == null)) ? this.m_fallbackSourceMaterial.GetInstanceID() : 0;
			if (instanceID != instanceID2)
			{
				if (!(this.m_fallbackMaterial != null) || num != instanceID)
				{
					return;
				}
		...
		private void SetSharedMaterial(Material mat)
		{
			...
			if (this.m_sharedMaterial != null)
			{
				base.gameObject.name = "TMP SubMesh [" + this.m_sharedMaterial.name + "]";
			}
		}
		...
		protected void UpdateMaterial()
		{
			...
			if (this.m_sharedMaterial != null && base.gameObject.name != "TMP SubMesh [" + this.m_sharedMaterial.name + "]")
			{
				base.gameObject.name = "TMP SubMesh [" + this.m_sharedMaterial.name + "]";
			}
		}
